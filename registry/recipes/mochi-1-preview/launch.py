...
sys.path.append("/opt/mochi/demos")
...
@click.option("--port", default=7860, type=int, help="Port to bind the Gradio app to.")
@click.option("--server-name", default="0.0.0.0", help="Server host for the Gradio app.")
def launch(model_dir, lora_path, cpu_offload, port, server_name):
